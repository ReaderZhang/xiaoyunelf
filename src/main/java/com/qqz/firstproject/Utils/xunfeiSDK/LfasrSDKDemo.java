package com.qqz.firstproject.Utils.xunfeiSDK;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.iflytek.msp.lfasr.LfasrClient;
import com.iflytek.msp.lfasr.model.Message;
import com.qqz.firstproject.FirstprojectApplication;
...
public class LfasrSDKDemo {
    private static final String APP_ID = "5ed8bc75";
    private static final String SECRET_KEY = "d653e49583597dad2d5b65c4198e9353";
    ...
    //3、通过classpath：
    private static final String AUDIO_FILE_PATH = FirstprojectApplication.class.getResource("/").getPath()+"/audio";
//    private static final String AUDIO_FILE_PATH = "F:\\xunfeiSDK\\src\\main\\resources\\audio\\lfasr.wav";
    /**
     * 注意：同时只能执行一个 示例
     *
     * @param args a
     ...
     * @throws InterruptedException e
     */
    public static String standard(String path) throws InterruptedException {
        //1、创建客户端实例
